...
public class Task2 implements Task {
  ...
  /**
   * Метод объединяет две переданные ему коллекции обобщенного типа Person,
   * сортирует полученные данные по дате создания Person
   * и выдвет заданное количество первых элементов.
   * @param persons1 - первая коллекция.
   * @param persons2 - вторая коллекция.
   * @param limit - количество первых элементов к выдаче.
